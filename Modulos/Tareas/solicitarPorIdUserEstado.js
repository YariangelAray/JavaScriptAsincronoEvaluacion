...
//Función para solicitar las tareas de un usuario, recibe como parámetro el id del usuario y el estado de la tarea
export const solicitarTareasIdEstado = async (idUser, pendiente) => await realizarPeticion(`/todos?userId=${idUser}&completed=${pendiente}`); 
